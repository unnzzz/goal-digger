        ...
        <div className="content-sidebar">
          <div className="sidebar-section">
            ...
            <ul className="sidebar-list">
              ...
              <li>AI-generated articles and podcasts when web resources are limited.</li>
              <li>Pass quizzes to unlock next day's content.</li>
              <li>We will send you a reminder email daily to remind you to complete your daily tasks.</li>
