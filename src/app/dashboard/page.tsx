...
function isCompleted(it: DailyItem) {
  if (it.section === "quiz") {
    ...
    const quizPassed = localStorage.getItem(`quiz-passed-${it.goalId}-day-${it.dayNumber}`) === 'true';
    const quizCompleted = localStorage.getItem(`quiz-completed-${it.goalId}-day-${it.dayNumber}`);
